namespace Dataweb.nShape.Designer {
	...
	partial class LayoutView {
		...
		private void InitializeComponent() {
			...
			this.keepAspectRationCheckBox.CheckedChanged += this.keepAspectRationCheckBox_CheckedChanged;
			// 
			...
			this.verticalCompressionTrackBar.Scroll += this.verticalCompressionTrackBar_Scroll;
			// 
			...
			this.horizontalCompressionTrackBar.Scroll += this.horizontalCompressionTrackBar_Scroll;
			// 
			// label7
			// 
			...
			this.gridDescriptionLabel.Text = "Positions the shapes on grid intersections that depend on the average shape pieRadius " +
					"and the set distances.";
			// 
			// rowDistanceLabel
			// 
			...
			this.rowDistanceTrackBar.Scroll += this.rowDistanceTrackBar_Scroll;
			// 
			...
			this.columnDistanceTrackBar.Scroll += this.columnDistanceTrackBar_Scroll;
			// 
			// label4
			// 
			...
			this.centerButton.Click += this.centerButton_Click;
			// 
			// layoutTimer
			// 
			...
			this.repulsionStrengthTrackBar.Scroll += this.repulsionStrengthTrackBar_Scroll;
			// 
			...
			this.attractionStrengthTrackBar.Scroll += this.attractionStrengthTrackBar_Scroll;
			// 
			// repulsionLabel3
			// 
			...
			this.leftToRightRadioButton.Size = new System.Drawing.Size(78, 17);
			...
			this.topDownRadioButton.Size = new System.Drawing.Size(73, 17);
			...
			this.rightToLeftRadioButton.Size = new System.Drawing.Size(79, 17);
			...
			this.bottomUpRadioButton.Size = new System.Drawing.Size(73, 17);
			...
			this.algorithmListBox.SelectedIndexChanged += this.algorithmListBox_SelectedIndexChanged;
			// 
			// LayoutView
			// 
			...
			this.Load += this.LayoutControlForm_Load;
			this.Shown += this.LayoutControlForm_Shown;
